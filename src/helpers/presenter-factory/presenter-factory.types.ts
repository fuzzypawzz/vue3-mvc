...
export type PresenterFactoryFunction<TProps, TView, TPresenterConfig extends PresenterConfig> = (
  props: TProps,
  view: TView
) => TPresenterConfig

type PresenterSpyFunction<TPresenterConfig extends PresenterConfig> =
  () => PresenterHookOutput<TPresenterConfig>

type MockViewModelFunction<TPresenterConfig extends PresenterConfig> = (
  viewModelOverride: ViewModelOverride<TPresenterConfig>
) => void

export interface UsePresenterHook<TProps, TView, TPresenterConfig extends PresenterConfig> {
  (props: TProps, view: TView): PresenterHookOutput<TPresenterConfig>
  spy: PresenterSpyFunction<TPresenterConfig>
  mockViewModel: MockViewModelFunction<TPresenterConfig>
}
